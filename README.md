# FoodEase
A Flutter-based food delivery application prototype that demonstrates core user flows including restaurant browsing, menu selection, customization, order tracking, and account management. The prototype showcases a complete visual design system with multiple interconnected screens.
